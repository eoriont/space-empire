...
assert_player_scouts(1, 1, (4, 0), 3)
assert_player_scouts(1, 2, (4, 4), 3)
...
assert_player_economic(1, 2, 5)

assert_player_scouts(1, 1, (4, 0), 3)
assert_player_scouts(1, 2, (4, 4), 3)
assert_player_scouts(1, 1, (2, 0), 2)
assert_player_scouts(1, 2, (2, 4), 2)

# 2 Movement Phase
print("Turn 2 Movement Phase")
game.movement.movement_phase(game.current_turn)
assert_player_scouts(2, 1, (4, 0), 5)
assert_player_scouts(2, 2, (4, 4), 5)
...
assert_player_economic(2, 2, 2)

assert_player_scouts(2, 1, (4, 0), 5)
assert_player_scouts(2, 2, (4, 4), 5)
assert_player_scouts(2, 1, (2, 0), 3)
assert_player_scouts(2, 2, (2, 4), 3)

# 3 Movement Phase
print("Turn 3 Movement Phase")
game.movement.movement_phase(game.current_turn)
assert_player_scouts(3, 1, (4, 0), 8)
assert_player_scouts(3, 2, (4, 4), 8)
...
assert_player_scouts(3, 1, (4, 0), 8)
assert_player_scouts(3, 2, (4, 4), 8)
assert_player_scouts(3, 1, (2, 0), 2)
assert_player_scouts(3, 2, (2, 4), 2)

assert_player_economic(3, 1, 2)
assert_player_economic(3, 2, 2)

# 4 Movement Phase
print("Turn 4 Movement Phase")
game.movement.movement_phase(game.current_turn)
assert_player_scouts(4, 1, (4, 0), 10)
assert_player_scouts(4, 2, (4, 4), 10)
